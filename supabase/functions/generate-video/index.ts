...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Simple, witty hand-drawn stick-figure explainer illustration on an off-white paper background with subtle paper grain. Black marker/ink line art with slightly imperfect, sketchy strokes. Characters are round-headed stick figures with minimal facial features (dots for eyes, small mouth). Simple props drawn with clean outlines and light crosshatching or pencil shading for depth. Very limited accent colors (only 1-3 pops like yellow, red, teal) while keeping most of the drawing black-and-white. Composition feels like a business/psychology Instagram cartoon: clear visual metaphor, lots of negative space, readable at a glance, humorous but clean. Subtle ground shadow scribbles under characters/objects. High resolution, crisp lines. No 3D, no Pixar, no anime, no realistic rendering, no glossy gradients, no heavy textures, no complex backgrounds, no photographic elements.`,
