...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Hand-drawn stick figure comic style. Crude, expressive black marker lines on CLEAN PURE WHITE background (NO notebook lines, NO lined paper, NO ruled paper, NO grid). Extremely simple character designs (circles for heads, single lines for limbs). No fill colors—strictly black and white line art. NO SKIN COLOR, NO FLESH TONES. Focus on humor and clarity. Rough, sketchy aesthetic similar to 'XKCD' or 'Wait But Why'. Imperfect circles and wobbly lines to emphasize handmade napkin-sketch quality. High resolution.`,
