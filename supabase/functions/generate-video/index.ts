...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Hand-drawn stick figure comic style. Simple stick figures with circular heads and single lines for limbs. NO SKIN COLOR—strictly black and white line art for all people and characters. White unfilled circles for heads, black outline only. Clean white background. Minimal color ONLY for objects like boxes, bags, or props—never on human figures. Expressive black marker lines. Extremely simple character designs. Focus on clarity and storytelling. Similar to XKCD or editorial cartoon style. Imperfect hand-drawn quality with wobbly lines.`,
