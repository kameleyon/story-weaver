...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Neo-Stick Illustration. A professional Neo-Stick illustration centered on a solid matte white background. Anatomy & Form: Playful Geometry—perfect circles for heads and uniform, thick rounded-cap lines for limbs, with dynamic motion (leaning, jumping, gesturing) to feel alive rather than static. Linework: Bold Monoline—thick, consistent black lines like a premium felt-tip marker, with slightly curved lines for bends in arms and legs giving a rubbery, expressive feel. Minimal Color Logic: Selective Highlighting—clean textured off-white background, color used only to highlight specific interaction points or props (bright yellow lightbulb, blue backpack, red heart) with vibrant saturated palette to pop against black and white character. Vibe: Modern & Catchy—feels like a premium tech startup onboarding screen, friendly, approachable, and professional, not like a child's doodle. Environment: Zero-Horizon—no ground or floor lines, character and colorful props float in center surrounded by clean white space. Ultra-clean 2D vector aesthetic with no gradients, no shadows, no complex backgrounds. High-contrast, playful, modern commercial graphic style. High-resolution, crisp rounded terminals on all lines.`,
  ...
  anime: `Cinematic Cel-Shaded Anime. A high-end cinematic anime-style illustration. Linework: Tapered Digital Ink—very thin lines in dark brown or deep navy rather than pitch black, making colors feel integrated and expensive. Color Palette: Atmospheric Vibrancy—high saturation in environment (bright blue skies, neon cherry blossoms) contrasted with soft creamy skin tones, Gradient Cel-Shading where shadows have slight soft transition at edges rather than flat blocks. Lighting: Lens Flare & Bloom—heavy bloom (glow) on light-colored surfaces, natural light effects like dappled sunlight (komorebi) or subtle lens flares for cinematic movie feel. Background Detail: Painterly Realism—while characters are flat and stylized, backgrounds are highly detailed hand-painted gouache or digital paintings with rich textures. Character Design: Moé Aesthetic—large expressive eyes with multiple reflection levels, thin noses, stylized clumped hair with distinct highlights (angel ring shine). Professional cel-shading with soft gradients, dramatic atmospheric lighting. Vibrant color palette with high-detail painterly backgrounds. Inspired by Makoto Shinkai and modern Kyoto Animation films. 4k digital art, masterpiece, serene and emotionally resonant aesthetic.`,
  ...
  claymation: `Tactile Claymation 3D. A high-detail 3D claymation-style render featuring tactile molded clay texture with subtle matte thumbprint-like surfaces (like Wallace & Gromit or Coraline). Materiality: The Clay Look—every surface has subtle matte texture, not smooth plastic but high-quality modeling clay. Lighting: Cinematic Studio Lighting—soft volumetric lighting with gentle rim lighting to separate subject from background, soft diffused shadows never harsh or pitch black. Character Proportions: Chibi-Influenced—large expressive glossy eyes, rounded limbs, exaggerated features, even mechanical objects have rounded edges and friendly toy-like feel. Depth of Field: Macro-Photography—shallow depth of field (bokeh) with softly blurred background, subject feels like a small precious collectible. Color Palette: Vibrant & Playful—highly saturated primary colors for main subject contrasted against softer multi-colored environment. Whimsical soft-focus background. Created in the style of high-end stop-motion animation. 8k resolution, Octane Render, masterpiece, adorable and high-quality craftsmanship.`,
  sketch: `Cinematic Editorial Sketch. A high-detail cinematic editorial sketch with hand-drawn sketchbook quality. Line Work: Loose and Scrawly—visible, overlapping sketchy lines that shouldn't look cleaned up, the charm comes from pencil-like under-drawing being visible beneath the color. Color Palette: Warm Muted Washes—desaturated earthy tones (peaches, sage greens, warm creams) that look like watercolor wash or digital marker. Character Design: Exaggerated Expressions—extreme facial acting with wide eyes, heavy brows, and emotive mouths making images feel like slice-of-life moments frozen in time. Texturing: Painterly Grit—backgrounds look unfinished and painterly with visible brush strokes and light paper texture, not solid walls of color but feeling like physical canvas. Composition: Candid Snapshot—subjects feel caught in middle of action or emotion rather than posing. Vibrant but warm muted color washes with visible painterly brushstrokes. Exaggerated emotive facial expressions and dynamic poses. Soft atmospheric lighting with subtle paper grain texture. Lo-fi, cozy, and highly expressive slice-of-life aesthetic. High-end digital watercolor illustration style with focus on storytelling.`,
};
