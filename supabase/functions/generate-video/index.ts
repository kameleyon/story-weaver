...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Simple stick figure illustration on clean off-white paper background. Characters are TRUE STICK FIGURES: round circle head (white fill with black outline), dot eyes, simple curved mouth, and SINGLE LINE STROKES for body, arms, and legs—NO BODY MASS, NO FILLED SHAPES, NO CARTOON BODIES. Arms and legs are just simple black lines. Black marker/ink linework with slightly wobbly hand-drawn strokes. Props and objects can have 1-3 accent colors (red, yellow, teal) but ALL human figures must be pure black-and-white stick figures with NO SKIN COLOR, NO FLESH TONES. Include scribbly gray ground shadows under figures. Clean visual metaphor, lots of negative space, readable at a glance. High resolution. No 3D, no Pixar, no anime, no realistic rendering, no glossy gradients, no filled body shapes.`,
