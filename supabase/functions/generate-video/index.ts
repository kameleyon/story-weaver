...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  caricature: `Dynamic Satirical Caricature. A professional editorial caricature in a satirical sketchbook style. Anatomy: Highly exaggerated features—large heads, expressive hands, and prominent facial features—used to convey personality and status. Line Work: Technical pen style with varied line weights, uses cross-hatching and scribble-shading to create depth and volume. Coloring: Soft desaturated watercolor washes that stay inside the lines but feel airy and light. Vibe: Professional editorial cartooning—sarcastic, smart, and storytelling-driven. Exaggerated character anatomy, expressive facial features, and detailed technical pen linework with cross-hatched shading. Colored with soft desaturated digital watercolor washes. Clean composition set against light-textured paper background. High-detail digital ink, witty storytelling aesthetic, sharp and expressive.`,
};
