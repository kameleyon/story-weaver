...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Marker-on-Paper Stick-Figure Explainer illustration on an off-white paper background with subtle paper grain. Black marker/ink line art with slightly imperfect, sketchy strokes. Characters are round-headed stick figures with minimal facial features (dots for eyes, small mouth)—CRITICALLY IMPORTANT: stick figures must be BLACK-AND-WHITE ONLY with NO SKIN COLOR, NO FLESH TONES, NO PEACH/TAN/BROWN coloring on any human figures. Simple props drawn with clean outlines and light crosshatching or pencil shading for depth. Very limited accent colors (only 1-3 pops like yellow, red, teal) for objects/backgrounds ONLY while keeping ALL human figures strictly black-and-white line art. Bold handwritten title at the top in a casual marker font. Composition feels like a business/psychology Instagram cartoon: clear visual metaphor, lots of negative space, readable at a glance, humorous but clean. Subtle ground shadow scribbles under characters/objects. High resolution, crisp lines. No 3D, no Pixar, no anime, no realistic rendering, no glossy gradients, no heavy textures, no complex backgrounds, no photographic elements, NO SKIN COLOR ON STICK FIGURES.`,
  ...
  crayon: `Child's crayon drawing style. WAXY CRAYON TEXTURE—visible scribbled strokes with uneven, scratchy color fill that doesn't stay within the lines. Overlapping crayon marks with heavy pressure variation creating darker and lighter patches. Simple childlike proportions with oversized heads and stick-like limbs. Warm, playful primary and pastel colors (orange, blue, yellow, peach, brown). White or cream textured paper background showing through the waxy crayon marks. Crude, charming imperfection with wobbly outlines and messy coloring. Innocent, joyful aesthetic like a proud child's refrigerator art. No sophisticated shading—just raw, enthusiastic crayon scribbles.`,
};
