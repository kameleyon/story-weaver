...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Crude hand-drawn stick figure comic style. IMPERFECT WOBBLY LINES—never perfectly straight or smooth, with visible hand tremor and uneven thickness like drawn quickly with a Sharpie marker. Simple stick figures with wobbly circular heads (not perfect circles) and single bent lines for limbs. NO SKIN COLOR—strictly black and white line art for all people and characters. White unfilled circles for heads, black outline only. Clean white background. Minimal color ONLY for objects like cards, boxes, or props—never on human figures. Extremely crude, sketchy character designs with shaky, unsteady linework. Focus on charming imperfection. Similar to XKCD, napkin sketches, or quick whiteboard doodles. Raw, unpolished, authentically hand-drawn aesthetic.`,
