...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  stick: `Hand-drawn stick figure comic style. Simple black marker/pen on white background. Extremely minimalist character designs: perfect circles for heads, single straight lines for limbs and bodies. Clean, bold black outlines with occasional diagonal hatching/shading on objects (boxes, bags, etc.). Characters have simple dot eyes and minimal curved lines for mouths when showing emotion. Text in bold, hand-drawn all-caps lettering with slight wobble. Objects drawn with basic geometric shapes and simple shading lines. High contrast black and white only—no grays or colors. Style looks like editorial cartoon illustrations or motivational poster graphics, NOT sketchy or rough. Clean, deliberate linework that is simple but polished. Premium quality.`,
