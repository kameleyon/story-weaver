...
// Import style preview images (reusing existing ones)
...
// Smart Flow uses a subset of 8 styles
...
const styles: { id: SmartFlowStyle; label: string; icon: React.ElementType; preview: string }[] = [
  ...
  { id: "doodle", label: "Doodle", icon: Pencil, preview: doodlePreview },
...
export function SmartFlowStyleSelector({ 
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-xs font-medium uppercase tracking-wider text-muted-foreground/70">Infographic Style</h3>
          ...
          >
            <div className="pt-3 px-1">
              ...
              <p className="text-xs text-muted-foreground/60 mt-1.5">
                Appears on your infographic as a signature
              </p>
            </div>
          </motion.div>
        )}
