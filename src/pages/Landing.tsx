...
const pricingPlans = [
  ...
  },
  {
    name: "Starter",
    price: "$14.99",
    description: "Hobbyists & creators",
    icon: Zap,
    features: ["30 credits/month", "1080p quality", "10 styles", "No watermark"],
    popular: false,
  },
  {
    name: "Creator",
    ...
    icon: Crown,
    features: ["100 credits/month", "All 13 styles", "Voice clone", "Priority support"],
    popular: true,
  },
  {
    name: "Professional",
    ...
    icon: Gem,
    features: ["300 credits/month", "4K quality", "API access", "3 team seats"],
    popular: false,
  },
  {
    name: "Enterprise",
    ...
    icon: Building2,
    features: ["Unlimited credits", "White-label", "Dedicated manager"],
    popular: false,
  },
];
